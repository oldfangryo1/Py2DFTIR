...
def func_FFT(yspec,pix_x,pix_y,N2=4096,pix_size=12*1e3,f=25*1e6,Dps=1.005661e6,phiy=44.874,center_x=320,center_y=256,wav1=7000,wav2=14000):
    #parameter setting
    N1 = len(yspec)
